...
#load data
setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI")

setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2100.85")
...
setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2100.26")
files <- list.files(pattern = ".asc$", recursive = F)
filez <- list.files(pattern = ".csv$", recursive = F)
...
setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2100.45")
files <- list.files(pattern = ".asc$", recursive = F)
filez <- list.files(pattern = ".csv$", recursive = F)

setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2050.26")
files <- list.files(pattern = ".asc$", recursive = F)
filez <- list.files(pattern = ".csv$", recursive = F)

setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2050.45")
files <- list.files(pattern = ".asc$", recursive = F)
filez <- list.files(pattern = ".csv$", recursive = F)

setwd("D:/PhD/LP/LP_SNP_Cliamte/GNI/2050.85")
files <- list.files(pattern = ".asc$", recursive = F)
filez <- list.files(pattern = ".csv$", recursive = F)
